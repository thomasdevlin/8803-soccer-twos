...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        restore = "./ray_results/PPO_curriculum/PPO_Soccer_e7e4a_00000_0_2026-04-24_11-33-13/checkpoint_000480/checkpoint-480",
    )
